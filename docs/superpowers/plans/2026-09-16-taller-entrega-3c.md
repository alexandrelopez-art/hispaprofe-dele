...
Leer el `migration.sql` que sale y comprobar a ojo que trae **tres tablas y cuatro índices únicos**, y **ninguna columna borrada**. Si toca algo de lo que ya había, el esquema se ha desviado: parar y avisar.
